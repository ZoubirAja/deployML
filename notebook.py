from settings import (FEATURE_TARGET, moustache, tableau_contengence_moyenne, test_new_feature, create_new_feature)
import pandas as pd
import numpy as np
...
for model in models_test:
    print("---------------------------", model[0], "----------------------")
    predict_model(X, y, precision_recall=True, model=model[1])